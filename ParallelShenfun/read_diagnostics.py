...
axes[0,0].semilogy(tt, TE[:-1], lw=3, color='k', label='Total')
axes[0,0].semilogy(tt, KE[:-1], lw=3, color='r', label='Kinetic', dashes=[6,2])
axes[0,0].semilogy(tt, PE[:-1], lw=3, color='g', label='Potential', dashes=[6,2])
axes[0,0].semilogy(tt, ME[:-1], lw=3, color='b', label='Magnetic', dashes=[6,2])
#axes[0,0].semilogy(tt, Q2[:-1]/Re, lw=3, color='m', label=r'$R_e^{-1}\iint q^2 dxdy$', dashes=[1,1])
#axes[0,0].semilogy(tt, j2[:-1]/Rm, lw=3, color='c', label=r'$R_m^{-1}\iint j^2 dxdy$', dashes=[1,1])
...
axes[1,0].semilogy(tt, lor[:-1], lw=3, color='b', label=r'$M^2 \sqrt{(b \cdot \nabla j)^2}$')
